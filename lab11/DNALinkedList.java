...
public class DNALinkedList 
{
    ...
    {
    	Node<Character>  pointer = startNode;
        for(int i= 0; i< target.length(); i++){
        	if(pointer == null) {
        		return false;
        	}
        	if(!pointer.data.equals(target.charAt(i)) ){
        		return false;
        	}
    ...
    public void transpose(String transposon, String target)
    {
        ...
        if (firstNodeOfTransposon == null) {
        	throw new IllegalArgumentException("Can not find transpose");
        }
    ...
    public static void main(String[] args)
    {
    	...
    	System.out.println("Expected: AACTGGGGG");
    	
//    	DNALinkedList l = new DNALinkedList("ABCDE");
//    	System.out.println(l);
//    	DNALinkedList l1 = new DNALinkedList("");
//    	System.out.println(l1);
//    	Node<Character> c = l.head.next;
//    	System.out.println(l.matches(c, "BCDEA"));
//    	System.out.println(l.find("ABCD"));
//    	
